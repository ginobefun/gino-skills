...
本项目是个人 Codex Skills 集合，通过 skills 扩展 Codex 的能力。
...
6. **创建 symlink 测试**: `ln -sf skills/<name> ~/.Codex/skills/<name>`
...
```bash
# 单个安装
ln -sf /path/to/gino-skills/skills/<skill-name> ~/.Codex/skills/<skill-name>
