...
**你的评分直接决定内容是否展示给用户**：HIGH/MEDIUM 优先级来源 ≥75 分上架，LOW 优先级来源 ≥80 分上架。评分必须准确反映内容质量，**适度放宽优质内容分数，让更多有价值的内容进入 85+ 区间**。
...
```json
{
  ...
  "score": 90,
  "remark": "【来源】HIGH 优先级（Google Chrome 团队成员个人博客），原创实践类，保底 82+。【得分】内容深度 32/35：全面覆盖 AI 辅助开发生命周期，分析严谨，论述完整，原创洞察为经验总结 5/7（有独立思考的工作流方法论）。实用性 23/25：高度可操作，提供具体工具和技术建议。相关性 18/20：AI 编程工作流高度契合目标受众。表达质量 9/10：结构清晰，语言精准。创新性 6/10：工作流方法论有观点有实践。【校验】≥90 检查：原创实践 + 高实用价值 + HIGH 来源，三者有其二，通过。【推荐】顶级内容，推荐阅读。"
}
```
...
```json
{
  ...
  "score": 86,
  "remark": "【来源】MEDIUM 优先级（SuperTechFans），优质策展类，保底 78+。【得分】内容深度 25/35：信息聚合，但筛选质量高，覆盖面广，有观点整理。实用性 20/25：部分内容有实践参考价值。相关性 19/20：信息覆盖面广，时效性强。表达质量 8/10：组织清晰。创新性 5/10：本质为策展，但有编辑价值。【策展说明】有明确筛选标准，不适用聚合减分。【推荐】优质推荐，适合快速获取技术热点。"
}
```
...
```json
{
  ...
  "score": 88,
  "remark": "【来源】HIGH 优先级（宝玉的分享），优质编译类，保底 82+。【得分】内容深度 26/35：高质量翻译整理，有结构化处理，原创洞察 4/7（有独立点评）。实用性 22/25：信息有参考价值，模型更新对开发者有直接帮助。相关性 19/20：AI 模型更新时效性强。表达质量 9/10：翻译通顺，结构清晰。创新性 4/10：编译转述但有价值。【编译转述说明】优质编译，有独立点评，上限放宽至 90。【推荐】优质推荐，值得阅读。"
}
```
...
```json
{
  ...
  "score": 85,
  "remark": "【来源】MEDIUM 优先级（大厂技术博客），原创实践类。【得分】内容深度 28/35：基于真实经验，有案例支撑，原创洞察 5/7（有独立观点的经验总结）。实用性 23/25：高度可操作，提供具体方法论和行动建议。相关性 18/20：职场发展对技术从业者高相关，非技术类内容同样重视。表达质量 9/10：结构清晰，语言精准。创新性 5/10：经验总结但有独特视角。【非技术类说明】职场/学习类内容对技术从业者有价值，相关性不打折。【推荐】优质推荐，适合 3-5 年经验工程师阅读。"
}
```
...
- **适度放宽，避免过严**：让更多优质内容进入 85+ 区间，**宁可偏高 2-3 分，避免过度压低**
...
**关键约束**：
- **95+ 极其稀有**，仅授予行业里程碑事件
- **90+ 保持稀缺性**：从"三者缺一不可"调整为"三者有其二"，但仍需严格校验，**不是约 8% 而是约 5%**
...
| 优先级 | 特征 | 评分影响 | 代表来源 |
|--------|------|----------|----------|
| **HIGH** | 一手权威：官方博客、核心创造者、顶级技术媒体 | 可触及 95+；原创内容基准 +5~8；**常规内容保底 82** | OpenAI, Anthropic, Martin Fowler, Andrej Karpathy, Cursor Blog, Cloudflare Blog, 阮一峰，宝玉的分享 |
| **MEDIUM** | 优质来源：知名社区、大厂博客、头部 KOL | **上限 93**；原创内容基准 +2~4；**常规内容保底 78** | ByteByteGo, Netflix TechBlog, Google Cloud Blog, 美团技术团队 |
| **LOW** | 一般来源：长尾博客、小众社区、新订阅源 | **上限 89**；基准不调整；**常规内容保底 72** | 多数个人博客、小型公司博客 |
...
| **编译转述** | 翻译、书评、课程笔记、会议整理 | 基准 -2~4；**上限 89**，优质编译可突破至 90+ |
...
**重要调整**：
- **放宽原创洞察标准**：不一定要有「首次提出」的方法论，**有独立思考、有观点、有信息整合价值**即可获 3-5 分
...
1. 先识别来源优先级和原创性级别，确定天花板和保底分
2. 按 5 维度逐项评分，在 remark 中列出各维度得分
3. 应用减分项（如适用）
4. 执行校准检查，必要时调整分数
5. 确保最终分数不超过天花板，且不低于保底分（除非有明显质量问题）

**核心调整**：
- **适度放宽 85+ 门槛**，让更多优质内容进入推荐区间
- **非技术类内容（职场/学习/思维/生活）如果质量优秀，可获 85+ 分**
- **HIGH 来源常规内容保底 82 分，MEDIUM 来源保底 78 分**
- **头部厂商（OpenAI/Anthropic/Google 等）的模型更新、工程实践可适当提高分数**
