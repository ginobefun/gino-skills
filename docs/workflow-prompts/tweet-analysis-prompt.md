...
[
  {
    ...
    "score": 92,
    "remark": "【来源】HIGH 优先级（OpenAI CEO Sam Altman），官方首发。【得分】信息价值(36/40)：4.5GW 级基础设施合作首发公告，CEO 一手信息，行业级影响力事件，新闻重要性极高(17/18)，信息密度中上(10/12)，来源可靠性高(9/10)。实用性(16/25)：行业动态时效性极强，对 AI 基础设施投资有参考价值。原创与深度(5/15)：官方首发信息，非分析洞察但信息独家性高。影响力(10/10)：行业头部 CEO 发布，涉及数十亿美元级别合作。呈现质量(8/10)：表达清晰，附现场照片佐证。【校验】≥90 检查：HIGH 来源 + 重磅资讯首发（行业级影响力），通过。【推荐】顶级内容，AI 基础设施领域重大进展，值得重点关注。"
  },
  {
    ...
    "score": 82,
    "remark": "【来源】HIGH 优先级（Sam Altman），Thread 后续。【得分】信息价值(26/40)：超 5000 亿美元投资扩展计划是重要信息，但作为 Thread 后续信息增量有限(13/18)，信息密度较低(6/12)，来源可靠(7/10)。实用性(13/25)：战略层面信息，时效性强但无具体执行细节。原创与深度(4/15)：官方发布但内容简短。影响力(8/10)：CEO 发布。呈现质量(7/10)：表达清晰简洁。【减分】Thread 补充推文，独立信息价值较主推文低(-4)。【推荐】合格展示，建议结合主推文一起阅读。"
  }
]
```
...
- **宁低勿高，防止通胀**：推文受字数限制，天然难以达到文章的信息密度，不确定时偏低 2-3 分
- **与文章评分有区分**：同主题的深度分析文章通常比推文高 5-10 分，但推文在时效性首发方面有独特价值，两者互补而非替代
...
| **90-94** | 顶级 | ~8% | HIGH 来源 + 以下任一：(1) 重磅资讯/产品首发（行业级影响）(2) 权威原创深度洞察 Thread | Sam Altman 重大合作公告、Andrej Karpathy 深度技术 Thread、CEO 重要产品/进展发布 |
...
**关键约束**：
- **95+ 极其稀有**，仅限「行业会记住的时刻」的官方首发（如新一代旗舰模型发布）
- **90-94 允许但要求高**：HIGH 来源的重磅资讯/产品首发（行业级影响力）或权威人士深度 Thread。普通功能更新、常规进展不够格
...
| 重磅资讯/战略级公告（官方首发） | 88-94 | CEO/官方首发，行业级影响力（如重大合作、巨额投资） |
| 重要功能更新/版本发布 | 82-88 | 产品迭代，非里程碑 |
| 权威人士原创深度洞察 | 85-93 | Thread + 深度分析，需 500+ 字，HIGH 来源可达 93 |
...
**2. 顶级校验（≥90）：**
- 是否满足以下**任一**条件？
  - (a) HIGH 来源 + 重磅资讯/产品首发，且具有**行业级影响力**（如重大合作、新模型发布、战略级公告）
  - (b) HIGH 来源 + 权威原创深度洞察（Thread + 500 字以上，有独立分析和见解）
...
**防通胀核心**：多数推文应在 65-82 分区间，85+ 应是少数有明确亮点的高价值信息。90+ 需要 HIGH 来源 + 重磅首发（行业级影响力）或深度 Thread，允许但门槛依然很高。如果一批推文中超过 20% 获得 85+ 分或超过 10% 获得 90+ 分，你的评分标准可能过于宽松。
