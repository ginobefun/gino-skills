...
def parse_args() -> object:
    parser = ExampleArgumentParser(description="通过统一 worker 执行 bilibili-cli 写操作命令。")
    parser.add_argument("--subcommand", required=True, help="例如 like、coin、triple、dynamic-post、unfollow。")
...
def main() -> int:
    ...
    try:
        ...
        payload = run_cli_worker(
            command=["bili", args.subcommand, *args.args, "--json"],
