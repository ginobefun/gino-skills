...
def parse_args() -> object:
    parser = ExampleArgumentParser(description="通过统一 worker 执行 bilibili-cli 读取命令。")
    parser.add_argument("--subcommand", required=True, help="例如 hot、rank、search、video、user。")
