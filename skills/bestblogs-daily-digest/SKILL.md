...
- **国内**: 机器之心, 新智元, 量子位, 赛博禅心, 数字生命卡兹克, 十字路口Crossing, 歸藏的AI工具箱, Founder Park, 腾讯科技, 腾讯技术工程, InfoQ 中文, 阮一峰的网络日志, 宝玉的分享, SuperTechFans, Datawhale, 魔搭ModelScope社区, 阿里技术, 阿里云开发者, 腾讯云开发者, 大淘宝技术, 前端早读课
...
- **国内**: 张小珺Jùn｜商业访谈录, 十字路口Crossing (播客), 晚点LatePost
