...
本 skill 使用 Admin API（查询列表、保存分析/翻译结果）+ OpenAPI（获取文章 Markdown 正文）。
...
> 通用错误码见 `../../references/shared/error-handling-bestblogs.md`。完整错误处理表见 `references/workflow-details.md`。
