---
name: xgo-track-kol
description: "通过 XGo (xgo.ing) 开放接口深度分析 Twitter/X KOL。适用场景：(1) 分析某 KOL 的活跃度和影响力，(2) 查看 KOL 的内容分布和互动趋势，(3) 对比两个 KOL 的数据差异，(4) 发现 KOL 的高光推文，(5) 评估是否值得关注某博主。触发短语：'分析 KOL', '追踪 KOL', 'track KOL', 'KOL 分析', 'KOL 对比', 'compare KOL', '博主分析', '分析博主', 'analyze user', '用户深度分析', '对比用户', 'compare users', '这个人怎么样', '值得关注吗', 'worth following', 或任何与 KOL 追踪、用户深度分析、用户对比相关的表述。"
---
